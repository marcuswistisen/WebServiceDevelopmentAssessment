...
public class ArticleService {
	@Context
	 ...
	 @Produces(MediaType.APPLICATION_XML)
	 @XmlElementRef
	 public ArrayList<Article> getArticles(@QueryParam("name") String author) throws JAXBException, IOException{
			 return getArticleApp().getArticles().findByAuthor(author);
