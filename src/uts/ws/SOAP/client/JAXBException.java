...
public class JAXBException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private uts.ws.SOAP.client.StackTraceElement[] linkedException;
    ...
    public JAXBException(
           ...
           uts.ws.SOAP.client.StackTraceElement[] linkedException,
     ...
     */
    public uts.ws.SOAP.client.StackTraceElement[] getLinkedException() {
        return linkedException;
    }
     ...
     */
    public void setLinkedException(uts.ws.SOAP.client.StackTraceElement[] linkedException) {
        this.linkedException = linkedException;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://SOAP.ws.uts/", "JAXBException"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://SOAP.ws.uts/", "stackTraceElement"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
